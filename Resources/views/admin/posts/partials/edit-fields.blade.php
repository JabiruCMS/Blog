<div class="box-body">
    <div class='form-group{{ $errors->has("$lang.title") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[title]", old("$lang.title", $oldTitle), ['class' => 'form-control', 'maxlength' => '190', 'data-slug' => 'source', 'placeholder' => trans('blog::post.form.title')]) !!}
    ...
    <div class='form-group{{ $errors->has("$lang.slug") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[slug]", old("$lang.slug", $oldSlug), ['class' => 'form-control slug', 'maxlength' => '190', 'data-slug' => 'target', 'placeholder' => trans('blog::post.form.slug')]) !!}
